              ...
              <div className="mt-6 space-y-4">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white/80 dark:bg-[#020617]/80 px-2 text-slate-500 font-semibold backdrop-blur-sm">OR CONTINUE WITH</span>
                  </div>
                </div>
                ...
                <Button 
                  ...
                  disabled={loading}
                  className="w-full h-12 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 font-semibold rounded-2xl shadow-[0_4px_10px_rgba(0,0,0,0.05)] transition-all flex items-center justify-center gap-2"
                >
                ...
                <p className="text-center text-[11px] text-muted-foreground mt-2 font-medium">Only <span className="font-bold text-slate-700 dark:text-slate-300">@vnrvjiet.in</span> college emails allowed</p>
              </div>
            )}
